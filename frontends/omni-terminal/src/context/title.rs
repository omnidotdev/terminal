...
pub fn create_title_extra_from_context<T: terminal_backend::event::EventListener>(
    context: &Context<T>,
...
#[inline]
pub fn update_title<T: terminal_backend::event::EventListener>(
    template: &str,
    context: &Context<T>,
) -> String {
...
pub mod test {
    ...
    use terminal_backend::event::VoidListener;
    use terminal_backend::sugarloaf::layout::SugarDimensions;
