...
use terminal_window::dpi::{LogicalSize, PhysicalPosition, PhysicalSize};
use terminal_window::event::{
    DeviceEvent, DeviceId, Ime, MouseButton, MouseScrollDelta, WindowEvent,
};
use terminal_window::event_loop::{ActiveEventLoop, EventLoop};
use terminal_window::keyboard::{Key, ModifiersState};
...
#[cfg(macos_platform)]
use terminal_window::platform::macos::{
...
impl Application {
    ...
    fn create_window(
        ...
        #[cfg(web_platform)]
        {
            use terminal_window::platform::web::WindowAttributesExtWebSys;
        ...
        #[cfg(ios_platform)]
        {
            use terminal_window::platform::ios::WindowExtIOS;
