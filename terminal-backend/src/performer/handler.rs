...
/// Get termcap/terminfo capability value for Omni Terminal.
fn get_termcap_capability(name: &str) -> Option<String> {
    match name {
        // Terminal name
        "TN" | "name" => Some("omni-terminal".to_string()),
...
mod tests {
    ...
    fn test_single_capability_requests() {
        ...
        assert_eq!(response, "\x1bP1+r544E=6F6D6E692D7465726D696E616C\x1b\\");
