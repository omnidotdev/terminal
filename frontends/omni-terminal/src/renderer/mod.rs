...
impl Renderer {
    ...
    fn is_position_in_hint_matches(
        matches: &[terminal_backend::crosswords::search::Match],
        pos: Pos,
    ) -> bool {
    ...
    fn create_line(
        ...
        hint_matches: Option<&[terminal_backend::crosswords::search::Match]>,
...
mod tests {
    ...
    fn test_empty_hint_matches() {
        let matches: Vec<terminal_backend::crosswords::search::Match> = vec![];
