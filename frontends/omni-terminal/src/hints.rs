...
impl HintState {
    ...
    pub fn update_matches<T: EventListener>(
        &mut self,
        term: &terminal_backend::crosswords::Crosswords<T>,
    ) {
        self.matches.clear();
...
mod tests {
    use super::*;
    use terminal_backend::config::hints::{HintAction, HintInternalAction};
        ...
        state.matches = vec![
            HintMatch {
                ...
                start: terminal_backend::crosswords::pos::Pos::new(
                    terminal_backend::crosswords::pos::Line(0),
                    terminal_backend::crosswords::pos::Column(0),
                ),
                end: terminal_backend::crosswords::pos::Pos::new(
                    terminal_backend::crosswords::pos::Line(0),
                    terminal_backend::crosswords::pos::Column(5),
                ),
                hint: Rc::new(Hint {
                    regex: Some("test".to_string()),
                    hyperlinks: false,
            ...
            HintMatch {
                ...
                start: terminal_backend::crosswords::pos::Pos::new(
                    terminal_backend::crosswords::pos::Line(0),
                    terminal_backend::crosswords::pos::Column(10),
                ),
                end: terminal_backend::crosswords::pos::Pos::new(
                    terminal_backend::crosswords::pos::Line(0),
                    terminal_backend::crosswords::pos::Column(15),
                ),
                hint: Rc::new(Hint {
                    regex: Some("test".to_string()),
                    hyperlinks: false,
