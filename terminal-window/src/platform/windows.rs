...
pub trait EventLoopBuilderExtWindows {
    ...
    ///
    /// ```
    /// use terminal_window::event_loop::EventLoopBuilder;
    /// #[cfg(target_os = "windows")]
    /// use terminal_window::platform::windows::EventLoopBuilderExtWindows;
    ///
...
pub trait WindowExtWindows {
    ...
    /// use terminal_window::raw_window_handle::HasWindowHandle;
    ///
