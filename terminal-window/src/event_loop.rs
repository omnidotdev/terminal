...
impl<T> EventLoop<T> {
    ...
    {
        let _span = tracing::debug_span!("terminal_window::EventLoop::run").entered();
    ...
    pub fn listen_device_events(&self, allowed: DeviceEvents) {
        let _span = tracing::debug_span!(
            "terminal_window::EventLoop::listen_device_events",
            allowed = ?allowed
        )
        .entered();
    ...
    pub fn set_confirm_before_quit(&self, confirmation: bool) {
        let _span =
            tracing::debug_span!("terminal_window::EventLoop::set_confirm_before_quit")
                .entered();
    ...
    pub fn create_window(
        ...
        let _span = tracing::debug_span!(
            "terminal_window::EventLoop::create_window",
...
impl ActiveEventLoop {
    ...
    pub fn create_window(
        ...
        let _span = tracing::debug_span!(
            "terminal_window::ActiveEventLoop::create_window",
            window_attributes = ?window_attributes
        )
        .entered();
    ...
    pub fn available_monitors(&self) -> impl Iterator<Item = MonitorHandle> {
        let _span =
            tracing::debug_span!("terminal_window::ActiveEventLoop::available_monitors",)
                .entered();
    ...
    pub fn listen_device_events(&self, allowed: DeviceEvents) {
        let _span = tracing::debug_span!(
            "terminal_window::ActiveEventLoop::listen_device_events",
            allowed = ?allowed
        )
        .entered();
