...
impl FontCache {
    ...
    pub fn pre_populate(
        ...
        let common_attrs = [
            Attributes::new(
                terminal_backend::sugarloaf::font_introspector::Stretch::NORMAL,
                terminal_backend::sugarloaf::font_introspector::Weight::NORMAL,
                terminal_backend::sugarloaf::font_introspector::Style::Normal,
            ),
            Attributes::new(
                terminal_backend::sugarloaf::font_introspector::Stretch::NORMAL,
                terminal_backend::sugarloaf::font_introspector::Weight::BOLD,
                terminal_backend::sugarloaf::font_introspector::Style::Normal,
            ),
            Attributes::new(
                terminal_backend::sugarloaf::font_introspector::Stretch::NORMAL,
                terminal_backend::sugarloaf::font_introspector::Weight::NORMAL,
                terminal_backend::sugarloaf::font_introspector::Style::Italic,
            ),
        ];
            ...
            for &ch in &common_chars {
                for &attrs in &common_attrs {
                    ...
                    if self.get(&key).is_none() {
                        let style = terminal_backend::sugarloaf::FragmentStyle {
                            font_attrs: attrs,
                            ..Default::default()
                        };
...
mod tests {
    use super::*;
    use terminal_backend::sugarloaf::font_introspector::{Stretch, Style, Weight};
