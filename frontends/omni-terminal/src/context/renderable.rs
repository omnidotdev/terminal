...
use terminal_backend::crosswords::pos::CursorState;
...
pub struct HintLabel {
    pub position: terminal_backend::crosswords::pos::Pos,
    pub label: Vec<char>,
    pub is_first: bool,
}
...
pub struct RenderableContent {
    ...
    pub hint_matches: Option<Vec<terminal_backend::crosswords::search::Match>>,
