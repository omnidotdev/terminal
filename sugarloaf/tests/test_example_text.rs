...
#[cfg(target_arch = "wasm32")]
use terminal_window::platform::web::WindowBuilderExtWebSys;
...
async fn run() {
    ...
    #[cfg(target_arch = "wasm32")]
    let window = terminal_window::window::WindowBuilder::new()
        .with_title("sugarloaf-wasm")
        .with_inner_size(terminal_window::dpi::LogicalSize::new(width, height))
    ...
    let window = terminal_window::window::Window::new(&event_loop).unwrap();
